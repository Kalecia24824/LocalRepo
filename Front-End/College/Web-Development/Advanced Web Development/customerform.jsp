...
<meta charset="utf-8">
	...
	<meta name="description" content="My online portfolio that shows skills learned while working through various projects.">
...
<!-- can also find path like this...<a href="${pageContext.request.contextPath}${'/a5/index.jsp'}">A5</a> -->	
	...
	<div class="container">
		<div class="starter-template">
					...
					<% //for debugging, test input (test servlet provided): action="testInput" %> <!--Original is /customerAdmin-->
				...
				street: {
					validators: {
							...
							stringLength: {
								...
								regexp: {
								regexp: /^[a-zA-Z0-9,\-\s\.]+$/,
									message: 'Street can only letters, numbers, commas, hyphens, and periods'
								},																		
						},
				},
				...
				city: {
					validators: {
							...
							stringLength: {
								...
								regexp: {
								regexp: /^[a-zA-Z0-9,\-\s]+$/,
									message: 'City can only contain letters, numbers, hyphens and spaces characters (29 Palms)'
								},																		
						},
				},
