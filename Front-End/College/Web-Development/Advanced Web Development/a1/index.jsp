...
<meta charset="utf-8">
	...
	<meta name="description" content="My online portfolio that shows my skills through projects.">
...
<!-- can also find path like this...<a href="${pageContext.request.contextPath}${'/a5/index.jsp'}">A5</a> -->
	...
	<div class="container">
		<div class="starter-template">
					...
					<img src="img/ampps.png" class="img-responsive center-block" alt="Tomcat Installation" />
