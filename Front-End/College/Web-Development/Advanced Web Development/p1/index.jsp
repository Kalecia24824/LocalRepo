...
<meta charset="utf-8">
	...
	<meta name="description" content="My online portfolio that has projects I created through using required skills">
	...
	<div class="container">
		<div class="starter-template">
			<div class="row">
					...
					<div class="page-header"> <!--The header-->
					...
					<form id="add_customer_form" method="post" class="form-horizontal" action="#">
						...
						<div class="form-group"> <!--Total Sales-->
						...
						<div class="form-group"> <!--Notes-->
							...
							<div class="col-sm-4">
								<input type="text" class="form-control"  maxlength="225" name="notes" />
							</div>
						</div>
