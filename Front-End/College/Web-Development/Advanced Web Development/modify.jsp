...
<meta charset="utf-8">
	...
	<meta name="description" content="My online portfolio that illustrates skills learned while working through various project requirements.">
			...
			fields: {
				...
				street: {
					validators: {
						...
						regexp: {
							regexp: /^[a-zA-Z0-9,.\- ]+$/,
							message: 'Street can only contain letters, numbers, and hyphens'
						},									
					},
				},
