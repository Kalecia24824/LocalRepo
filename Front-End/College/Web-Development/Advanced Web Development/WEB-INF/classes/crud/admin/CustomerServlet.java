		...
		//from customers.jsp
		else if (action.equals("add_customer"))
			{
				...
				if(!isValidInput(firstName_v, lastName_v, street_v, city_v, state_v, zip_v, phone_v, email_v, balance_v, totalSales_v, notes_v))
					{
						message = "<span style='color: red; background-color: yellow; font-weight: bold; font-variant:small-caps;'>All text boxes required except Notes. Please check input.</span>";
